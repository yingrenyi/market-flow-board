...
美股页额外提供重点公司观察：SpaceX（SPCX）、镁光（MU）、英伟达（NVDA）、英特尔（INTC），展示实时价格、涨跌幅、成交量、成交额、消息热度、涨跌幅可能原因、期权 Call/Put 情绪比例和操作动作建议。股价使用轻量报价接口约 15 秒刷新一次；新闻、原因和期权情绪低频刷新。期权比例使用公开期权链的成交量或未平仓量估算，无法区分真实买卖方向。
